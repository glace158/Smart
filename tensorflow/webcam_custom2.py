...
fc = 14 #frame_rate_calc
filename = 'record.avi'
codec = cv2.VideoWriter_fourcc('D', 'I', 'V', 'X')
out = cv2.VideoWriter(filename, codec, fc, (int(videostream.get_width()), int(videostream.get_height())))
...
while True:
    ...
    cv2.putText(frame,'FPS: {0:.2f}'.format(frame_rate_calc),(0,10),cv2.FONT_HERSHEY_SIMPLEX,0.4,(255,255,0),1,cv2.LINE_AA)
